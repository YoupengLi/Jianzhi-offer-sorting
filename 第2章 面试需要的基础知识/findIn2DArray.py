...
class Solution:
    # array 二维列表
    def findIn2DArray(self, arr: 'list[int]', target: 'int') -> 'bool':
        # write code here
...
class Solution:
    ...
    def findIn2DArray_1(self, arr, target):
        # 从左下开始搜索
        if not isinstance(target, int):
            print('Error! The searched objective is not integer.')
            return
...
if __name__ == "__main__":
    ...
    res = a.findIn2DArray(arr, 7)
    print(res)
    res = a.findIn2DArray_1(arr, 7)
    print(res)
    res = a.findIn2DArray(arr, 0)
    print(res)
    res = a.findIn2DArray_1(arr, 17)
    print(res)
    res = a.findIn2DArray(arr, None)
    print(res)